...
export default function FlashSale() {
  const flashSaleProducts = [
     { id: 1, name: "Wireless Headphones", price: "$49", oldPrice: "$99", img: "/images/p3.jpeg", rating: 4, discount: 50 },
    { id: 2, name: "Smart Watch", price: "$79", oldPrice: "$129", img: "/images/p2.jpeg", rating: 5, discount: 40 },
    { id: 3, name: "Gaming Mouse", price: "$25", oldPrice: "$50", img: "/images/p1.jpeg", rating: 3, discount: 50 },
  ];
