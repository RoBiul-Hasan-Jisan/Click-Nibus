      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 relative group">
          <img 
            src={product.img} 
            alt={product.name} 
            className="w-full h-full max-h-[550px] object-contain rounded-3xl shadow-2xl transition-transform duration-500 group-hover:scale-110"
          />
          {product.discount && (
            <span className="absolute top-4 left-4 bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-1 rounded-full font-bold shadow-lg text-sm">
